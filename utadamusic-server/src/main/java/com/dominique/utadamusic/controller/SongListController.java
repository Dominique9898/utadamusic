...
import com.dominique.utadamusic.service.impl.SongListServiceImpl;
...
//    更新歌单信息
    ...
    public Object updateSongListImg(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "data"+System.getProperty("file.separator")+"img" + System.getProperty("file.separator") + "songListPic" ;
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songListPic/**").addResourceLocations("file:/Users/dominiquewei/Documents/Coding/Java-Web/vue/utadamusic/utadamusic-server/data/img/songListPic/");
        }
    }
//    返回所有歌单
