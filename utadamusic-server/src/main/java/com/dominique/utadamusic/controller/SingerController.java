...
import com.dominique.utadamusic.service.impl.SingerServiceImpl;
...
//    更新歌手信息
    ...
    public Object updateSingerImg(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") +"data"+System.getProperty("file.separator")+ "img" + System.getProperty("file.separator") + "singerPic" ;
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/singerPic/**").addResourceLocations("file:/Users/dominiquewei/Documents/Coding/Java-Web/vue/utadamusic/utadamusic-server/data/img/singerPic/");
        }
    }
//    返回所有歌手
