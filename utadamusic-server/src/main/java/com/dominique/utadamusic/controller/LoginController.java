...
import com.dominique.utadamusic.service.impl.ConsumerServiceImpl;
...
//    更新用户头像
    ...
    public Object updateUserImg(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") +"data"+System.getProperty("file.separator")+ "img" + System.getProperty("file.separator") + "avatorImages" ;
