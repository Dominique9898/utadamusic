    ...
    export default {
        ...
        methods: {
            ...
            getData () {
                ...
                _this.tableData = []
                _this.tempDate = []
                _this.$axios.get(this.$store.state.HOST+'/listSongOfSingers?songListId=' + _this.$route.query.id).then((res) => {
            ...
            getSong (id) {
                let _this = this
                _this.$axios.get(this.$store.state.HOST+'/listSongsOfSongs?id=' + id)
                    .then(function (res) {
            ...
            getSongId () {
                ...
                _this.$axios.get(this.$store.state.HOST+'/listSongsOfSearch?name=' + id).then((res) => {
            ...
            addSong (id) {
                ...
                _this.$axios.post(this.$store.state.HOST+'/api/addListSong', params).then((res) => {
                    if (res.data.code === 1) {
                        _this.getData()
                        _this.$notify({
                            title: '添加成功',
            ...
            deleteRow(){
                let _this = this
                _this.$axios.get(this.$store.state.HOST+'/api/deleteListOfSong?songId=' + _this.tableData[_this.idx].id)
                    .then(res => {
                        if (res.data) {
                            _this.getData()
                            _this.$notify({
