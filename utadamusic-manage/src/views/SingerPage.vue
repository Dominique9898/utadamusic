...
export default {
    ...
    methods: {
        ...
        addsinger () {
            ...
            _this.$axios.post(this.$store.state.HOST+'/api/addSinger', params)
                .then(res => {
                    console.log(res)
                    if (res.data.code === 1) {
                        _this.getData()
        ...
        getData() {
            ...
            _this.tableData = []
            _this.tempDate = []
            _this.$axios.get(this.$store.state.HOST+'/listSingers').then((res) => {
        ...
        saveEdit() {
            ...
            _this.$axios.post(this.$store.state.HOST+'/api/updateSingerMsgs', params)
                .then(response => {
        ...
        deleteRow(){
            var _this = this
            _this.$axios.get(this.$store.state.HOST+'/api/deleteSingers?id=' + _this.tableData[_this.idx].id)
                .then(response => {
                    if (response.data) {
                        _this.getData()
                        _this.$notify({
