...
export default {
    ...
    methods: {
        ...
        getData () {
            ...
            _this.tableData = []
            _this.tempDate = []
            _this.$axios.get(this.$store.state.HOST+'/AllUsers').then((res) => {
        ...
        addPeople () {
            ...
            _this.$axios.post(this.$store.state.HOST+'/api/signup', params)
                .then(response => {
        ...
        deleteRow(){
            var _this = this
            _this.$axios.get(this.$store.state.HOST+'/api/deleteUsers?id=' + _this.tableData[_this.idx].id)
                .then(response => {
                    if (response.data) {
                        _this.getData()
                        _this.$notify({
